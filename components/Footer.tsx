...
const Footer = memo(function Footer() {
  ...
  return (
    <footer className="bg-[var(--theme-bg)] text-[var(--foreground)] border-t-[3px] border-[var(--theme-border-muted)] mt-auto pb-[var(--sab,0px)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="flex flex-col items-center gap-3 text-center">
          <div className="flex items-center gap-3 sm:gap-4 text-xs sm:text-sm text-gray-400 flex-wrap justify-center">
            <span className="brand-title text-sm" data-text="AntStreet">AntStreet</span>
