...
- **포함 내용**:
  - 리포트 제목 중심의 동적 타이틀: `삼성전자 반도체 업황 회복 기대 (작성 당시 대비 +24.5%) - AntStreet`
...
# 특히 중요한 설정:
# - NEXT_PUBLIC_SITE_URL: https://antstreet.kr
# - Firebase 설정값들
\`\`\`
...
\`\`\`html
<title>삼성전자 반도체 업황 회복 기대 (작성 당시 대비 +24.5%) - AntStreet</title>
...
2. 속성 추가 → 도메인 입력
3. Sitemap 제출: `https://antstreet.kr/sitemap.xml`

#### 네이버 웹마스터 도구
1. https://searchadvisor.naver.com 접속
2. 사이트 등록
3. 사이트맵 제출: `https://antstreet.kr/sitemap.xml`
