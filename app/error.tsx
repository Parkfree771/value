  ...
  return (
    <div className="min-h-[calc(100vh-200px)] flex items-center justify-center px-4">
      <div className="text-center">
        <div className="w-16 h-16 mx-auto mb-6 bg-red-900/30 border-2 border-red-500 flex items-center justify-center shadow-md">
        ...
        {process.env.NODE_ENV === 'development' && error.message && (
          <div className="mt-8 p-4 bg-black/30 border-2 border-[var(--theme-border-muted)] text-left max-w-lg mx-auto shadow-md">
