    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <Card className="p-8">
        ...
        <div className="space-y-6 text-gray-700 dark:text-gray-300">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">1. 수집하는 개인정보의 항목 및 수집 방법</h2>

            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2 mt-4">가. 수집하는 개인정보 항목</h3>
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2 mt-4">나. 개인정보 수집 방법</h3>
            <ul className="list-disc list-inside ml-6 space-y-1">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">2. 개인정보의 수집 및 이용 목적</h2>
            <p className="mb-2">회사는 수집한 개인정보를 다음의 목적을 위해 활용합니다:</p>

            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2 mt-4">가. 서비스 제공</h3>
            <ul className="list-disc list-inside ml-6 space-y-1">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2 mt-4">나. 회원 관리</h3>
            <ul className="list-disc list-inside ml-6 space-y-1">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2 mt-4">다. 서비스 개선 및 마케팅</h3>
            <ul className="list-disc list-inside ml-6 space-y-1">
          ...
          <section>
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2 mt-4">가. 회사 내부 방침</h3>
            <ul className="list-disc list-inside ml-6 space-y-1">
              <li>부정 이용 방지: 1년</li>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">4. 개인정보의 파기 절차 및 방법</h2>

            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">가. 파기 절차</h3>
            <p className="ml-6">
              이용자가 입력한 정보는 목적 달성 후 별도의 DB에 옮겨져(종이의 경우 별도의 서류) 내부 방침 및 기타 관련
              법령에 따라 일정기간 저장된 후 혹은 즉시 파기됩니다.
            </p>

            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2 mt-4">나. 파기 방법</h3>
            <ul className="list-disc list-inside ml-6 space-y-1">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">5. 개인정보의 제3자 제공</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">6. 개인정보 처리의 위탁</h2>
            <p className="mb-2">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">7. 이용자 및 법정대리인의 권리</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">8. 개인정보 자동 수집 장치의 설치/운영 및 거부</h2>
            <p className="mb-2">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">9. 개인정보 보호책임자</h2>
            <p className="mb-2">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">10. 개인정보 처리방침의 변경</h2>
            <p>
