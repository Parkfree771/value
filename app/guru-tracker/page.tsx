      ...
      <section className="mb-6 sm:mb-8 bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800 dark:from-black dark:via-gray-950 dark:to-black rounded-none sm:rounded-2xl p-6 sm:p-8 shadow-2xl border-t-4 border-b-4 sm:border-4 border-amber-600 dark:border-amber-500 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="text-center mb-6 sm:mb-7">
            ...
            <p className="text-base sm:text-lg md:text-xl text-amber-100 tracking-wide font-light">
              투자의 거인을 추적하다
            </p>
          </div>

          <div className="max-w-3xl mx-auto text-center px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-amber-400 mb-4 sm:mb-5 tracking-widest">
              GURU
            </h2>
            ...
            <blockquote className="relative">
              <p className="text-sm sm:text-base md:text-lg text-gray-100 leading-relaxed font-serif italic mb-4 sm:mb-5">
                ...
                <br className="hidden sm:block" />
                우리는 그들을 <strong className="text-amber-300">투자의 구루</strong>라 부릅니다.
              </p>
            </blockquote>
